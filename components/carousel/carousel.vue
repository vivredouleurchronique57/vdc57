<template>
  <div id="indicators-carousel" class="relative w-full" data-carousel="static">
    ...
    <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
      ...
      <carousel-item v-for="post in posts" :key="post.order" class="hidden duration-700 ease-in-out" data-carousel-item>
      </carousel-item>
      <!-- Item 2 -->
...
export default {
  ...
  methods: {
    async fetchPosts(postType = this.postType, amount = 10, sortBy = this.sortBy) {
